...
**Summary**: Subscriber and Customer are the two different types of the user of the Bay Wheels and they differ in the way they access the bike, <br />when they access and how they access the bike and for how long. The answer to all these questions are available in the `slide_deck.ipynb`, <br />which also visualises the impact of the COVID-19 on the behaviour of the users and impact on their ridership.
